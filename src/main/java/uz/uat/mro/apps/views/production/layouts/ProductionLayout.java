package uz.uat.mro.apps.views.production.layouts;
...
import uz.uat.mro.apps.views.production.views.ProductionView;

public class ProductionLayout extends AppLayout {
    private H2 viewTitle;
    private Project project;

    public ProductionLayout() {
    ...
    private AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("Производство", ProductionView.class, "la la-file"));
        return nav;
    }
